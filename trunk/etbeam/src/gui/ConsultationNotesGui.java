...
public class ConsultationNotesGui extends JFrame implements EtBeamIF {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				//FIN
					ConsultationNotesGui frame = new ConsultationNotesGui();
	 ...
	 * @throws Exception 
	 */
	public ConsultationNotesGui() throws Exception {
