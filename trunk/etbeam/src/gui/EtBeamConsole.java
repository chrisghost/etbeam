		...
		while(alive){
					...
					command.equalsIgnoreCase("gl etue"))
			{
				try {
					...
					ArrayList<Etudiant> e=(Facade.getListeEtudbyUE(ue)); //R�cup�ration de la liste des �tudiants de l'UE
			...
			
			{
				try {
					...
					ArrayList<Etudiant> e=(Facade.getListeEtudECUE(ecue)); //R�cup�ration de la liste des �tudiants de l'ECUE
