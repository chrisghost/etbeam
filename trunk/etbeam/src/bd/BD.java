...
public abstract class BD {
	...
	/**	
     * permet d'obtenir le nombre de points jury attriub�s � un �tudiant pour une UE
     * @param ue l'UE pour laquelle on veut les points jury
     * @param e l'Etudiant dont on veut les points jury
     * @return le nombre de points jury UE attribu�s    
     */
	public abstract float getPtsJuryUE(UE ue, Etudiant e) ;
	
	
	/**	
     * permet d'obtenir le nombre de points jury attriub�s � un �tudiant pour un semestre
     * @param se le semestre pour lequel on veut les points jury
     * @param e l'Etudiant dont on veut les points jury
     * @return le nombre de points jury semestre attribu�s    
     */
	public abstract float getPtsJurySem(Semestre se, Etudiant e);


	/**	
     * permet d'obtenir la moyenne d'un �tudiant pour un semestre
     * @param sem le semestre pour lequel on veut la moyenne de l'�tudiant
     * @param et l'Etudiant dont on veut la moyenne au semestre
     * @return la moyenne obtenue par l'�tudiant au semestre    
     */
	public abstract double moyenneEtudiantSem(Semestre sem, Etudiant et);

	
	/**	
     * permet de changer la note obtenue � une ECUE par un �tudiant
     * @param ec l'ECUE pour laquelle on veut changer la note
     * @param et l'�tudiant � qui on vaut changer la note
     * @param note la note � affecter � l'�tudiant
     * @param session le num�ro de session concernant la note
     */
     ...
     * @param etudiant l'�tudiant � qui on veut ajouter des points
